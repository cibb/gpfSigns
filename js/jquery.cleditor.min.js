...
(function(n) {
    ...
    function ht(i) {
        ...
        var u = i.$frame = n('<iframe frameborder="0" />').hide().appendTo(s),
            l = u[0].contentWindow,
            f = i.doc = l.document,
            h = n(f);
        f.open();
        f.write(r.docType + "<html>" + (r.docCSSFile === "" ? "" : '<head><link rel="stylesheet" type="text/css" href="' + r.docCSSFile + '" /><\/head>') + '<body style="' + r.bodyStyle + '"><\/body><\/html>');
        f.close();
